                    ...
                    <section class="boxs-simple">
                        <div class="profile-header">
                            <div class="profile_info">
                                ...
                                @else
                                    <div class="profile-image"> <img src="storage/posts/'.{{ $post->image }} "
                                            alt="">
                                    </div>
                                @endif
                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane in active" id="usersettings">
                                    <div class="body">
                                        <div class="col-12">
                                            <textarea aria-valuetext="{{ $post->content }}" name="content" name="content" wire:model.defer="content"
                                                {{-- id="summernote" class="card-body summernote" --}} class="form-control col-12" cols="30" rows="20"></textarea>
                                            @error('content')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
