                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="sparkline" data-type="line" data-spot-Radius="3"
                            ...
                            data-spot-Color="rgb(63, 81, 181, 0.7)" data-offset="90" data-width="100%" data-height="100px"
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="sparkline" data-type="line" data-spot-Radius="3"
                            ...
                            data-height="100px" data-line-Width="1" data-line-Color="rgb(96, 125, 139, 0.7)"
                    ...
                    <div class="body">
                        <ul class="country-state">
                            <li class="m-b-20">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" aria-valuenow="50"
                                        aria-valuemin="0" aria-valuemax="100" style="width:58%;"> <span
                                            class="sr-only">58% Complete</span></div>
                                </div>
                            </li>
                            <li class="m-b-20">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="50"
                                        aria-valuemin="0" aria-valuemax="100" style="width:70%;"> <span
                                            class="sr-only">70% Complete</span></div>
                                </div>
                            </li>
                            <li class="m-b-20">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <li>
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" aria-valuenow="50"
                                        aria-valuemin="0" aria-valuemax="100" style="width:65%;"> <span
