...
} elseif ($_instance->childHasBeenRendered('GULfn8A')) {
    $componentId = $_instance->getRenderedChildComponentId('GULfn8A');
    $componentTag = $_instance->getRenderedChildComponentTagName('GULfn8A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GULfn8A');
} else {
    $response = \Livewire\Livewire::mount('front.register-hospital');
    $html = $response->html();
    $_instance->logRenderedChild('GULfn8A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH C:\Users\Benutzer\Blood\resources\views/auth/registerHospital.blade.php ENDPATH**/ ?>