...
} elseif ($_instance->childHasBeenRendered('uuKv5mf')) {
    $componentId = $_instance->getRenderedChildComponentId('uuKv5mf');
    $componentTag = $_instance->getRenderedChildComponentTagName('uuKv5mf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uuKv5mf');
} else {
    $response = \Livewire\Livewire::mount('front.contact.contact-manage');
    $html = $response->html();
    $_instance->logRenderedChild('uuKv5mf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
