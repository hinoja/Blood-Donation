...
} elseif ($_instance->childHasBeenRendered('C9fZxnF')) {
    $componentId = $_instance->getRenderedChildComponentId('C9fZxnF');
    $componentTag = $_instance->getRenderedChildComponentTagName('C9fZxnF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C9fZxnF');
} else {
    $response = \Livewire\Livewire::mount('front.contact.contact-manage');
    $html = $response->html();
    $_instance->logRenderedChild('C9fZxnF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
