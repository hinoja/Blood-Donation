...
} elseif ($_instance->childHasBeenRendered('2VYkulP')) {
    $componentId = $_instance->getRenderedChildComponentId('2VYkulP');
    $componentTag = $_instance->getRenderedChildComponentTagName('2VYkulP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2VYkulP');
} else {
    $response = \Livewire\Livewire::mount('admin.hospitals.manage-hospital');
    $html = $response->html();
    $_instance->logRenderedChild('2VYkulP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
