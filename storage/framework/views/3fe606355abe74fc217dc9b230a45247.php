    ...
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                ...
                <?php if(Auth()->user()->role_id === 1): ?>
                    BloodDonation
                <?php else: ?>
                    <?php echo app('translator')->get('Hospitals'); ?>
                <?php endif; ?>
            </a> </div>
        <ul class="nav navbar-nav navbar-right">
            <!-- Notifications -->
            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"
                    role="button"><i class="zmdi zmdi-notifications"></i> <span class="label-count">7</span> </a>
                <ul class="dropdown-menu">
                    ...
                    <li class="body">
                        <ul class="menu">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="icon-circle bg-blue-grey"><i class="zmdi zmdi-comment-alt-text"></i>
                                    </div>
                                    <div class="menu-info">
...
<?php /**PATH E:\Laravel Projet\Blood_Donation\resources\views/includes/back/navbar.blade.php ENDPATH**/ ?>