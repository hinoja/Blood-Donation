...
} elseif ($_instance->childHasBeenRendered('5bZy0xr')) {
    $componentId = $_instance->getRenderedChildComponentId('5bZy0xr');
    $componentTag = $_instance->getRenderedChildComponentTagName('5bZy0xr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5bZy0xr');
} else {
    $response = \Livewire\Livewire::mount('front.register-hospital');
    $html = $response->html();
    $_instance->logRenderedChild('5bZy0xr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
