...
} elseif ($_instance->childHasBeenRendered('LVaWYfP')) {
    $componentId = $_instance->getRenderedChildComponentId('LVaWYfP');
    $componentTag = $_instance->getRenderedChildComponentTagName('LVaWYfP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LVaWYfP');
} else {
    $response = \Livewire\Livewire::mount('front.register-hospital');
    $html = $response->html();
    $_instance->logRenderedChild('LVaWYfP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
