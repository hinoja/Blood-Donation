...
<head>
    ...
    <title>Blood Donation | <?php echo app('translator')->get('Reset Password'); ?></title>
...
<body class="theme-cyan authentication">
    ...
    <div class="container">
        ...
        <div class="card locked">
            <h1 class="title"> <?php echo app('translator')->get('Reset Password'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center">
                        <button type="submit" style="background: #ea3d3d;"
                            class="btn btn-raised waves-effect "><?php echo app('translator')->get('Submit Request'); ?></button>
                    </div>
...
<?php /**PATH E:\Laravel Projet\Blood_Donation\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>