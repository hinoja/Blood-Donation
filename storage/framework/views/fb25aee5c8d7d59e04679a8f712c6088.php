...
} elseif ($_instance->childHasBeenRendered('uk34ymx')) {
    $componentId = $_instance->getRenderedChildComponentId('uk34ymx');
    $componentTag = $_instance->getRenderedChildComponentTagName('uk34ymx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uk34ymx');
} else {
    $response = \Livewire\Livewire::mount('admin.manage-appointment');
    $html = $response->html();
    $_instance->logRenderedChild('uk34ymx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
