...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/back/css/customStyle.css')); ?>" />
...
<body  class="theme-cyan authentication">
    ...
    <div class="container" >
        ...
        <div class="card resize locked ">
            <h1 class="title" style="color: #ea3d3d;"> <?php echo app('translator')->get('Login'); ?>
                
            </h1>
            <div class="d-flex">
                <div class="thumb" style="margin:auto;">
                    <a href="<?php echo e(route('home')); ?>"> 
                        <img class="media-object"  style="width: 150px !important;" src="<?php echo e(asset('assets/back/images/bg2.jpg')); ?>" class="rounded" alt="logo">
                    </a>
                </div>
            </div>
            <div class="body">
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <!-- Email Address -->
                    <br>
                    <div class="input-group icon before_span <?php echo e($errors->has('email') ? 'has-error' : ''); ?>" style="width:500px; margin-left: 9rem !important;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Password -->
                    <br>
                    <div class="input-group icon before_span <?php echo e($errors->has('password') ? 'has-error' : ''); ?>" style="width:500px; margin-left: 9rem !important;">
                    ...
                    <div class="align-center">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                href="<?php echo e(route('password.request')); ?>" style="text-decoration: none;">
...
<?php /**PATH C:\Users\Benutzer\Blood\resources\views/auth/login.blade.php ENDPATH**/ ?>