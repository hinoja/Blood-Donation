...
} elseif ($_instance->childHasBeenRendered('WcNLAH1')) {
    $componentId = $_instance->getRenderedChildComponentId('WcNLAH1');
    $componentTag = $_instance->getRenderedChildComponentTagName('WcNLAH1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WcNLAH1');
} else {
    $response = \Livewire\Livewire::mount('admin.contacts.contact-manage');
    $html = $response->html();
    $_instance->logRenderedChild('WcNLAH1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
