                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-5">
                            <div class="organization-area__thumb dir-ltr mb-30 text-center">
                                <img src="<?php echo e(asset('assets/front/images/organization-illustration.png')); ?>"
                                    alt="Organization">
                            </div>
                        </div>
                        <div class="col-lg-7">
...
<?php /**PATH E:\Laravel Projet\Blood_Donation\resources\views/includes/front/organization.blade.php ENDPATH**/ ?>