...
<body class="theme-cyan authentication">
    <div class="container">
        ...
        <div class="card locked">
            <h1 class="title"> <?php echo app('translator')->get('Login'); ?> <span class="msg"><?php echo app('translator')->get('Sign In a  membership'); ?></span></h1>
            <div class="d-flex">
                <div class="thumb" style="margin:auto;">
                    <a href="<?php echo e(route('home')); ?>"> <img class="media-object" src="<?php echo e(asset('assets/back/images/bg2.jpg')); ?>" class="rounded"
                        alt="logo"></a>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="email"
                                value="<?php echo e(old('email')); ?>" tabindex="1" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <label for="remember_me"><span class="ml-2 text-sm text-gray-600"><?php echo e(__('Remember me')); ?></span>
                        </label>
                    </div>
