...
} elseif ($_instance->childHasBeenRendered('avfnJbH')) {
    $componentId = $_instance->getRenderedChildComponentId('avfnJbH');
    $componentTag = $_instance->getRenderedChildComponentTagName('avfnJbH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('avfnJbH');
} else {
    $response = \Livewire\Livewire::mount('admin.hospitals.manage-hospital');
    $html = $response->html();
    $_instance->logRenderedChild('avfnJbH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Benutzer\Blood\resources\views/admin/hospitals/index.blade.php ENDPATH**/ ?>