...
} elseif ($_instance->childHasBeenRendered('raSAZJU')) {
    $componentId = $_instance->getRenderedChildComponentId('raSAZJU');
    $componentTag = $_instance->getRenderedChildComponentTagName('raSAZJU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('raSAZJU');
} else {
    $response = \Livewire\Livewire::mount('admin.posts.add-post');
    $html = $response->html();
    $_instance->logRenderedChild('raSAZJU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
