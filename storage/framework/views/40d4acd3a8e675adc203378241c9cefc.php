...
} elseif ($_instance->childHasBeenRendered('4xbc10R')) {
    $componentId = $_instance->getRenderedChildComponentId('4xbc10R');
    $componentTag = $_instance->getRenderedChildComponentTagName('4xbc10R');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4xbc10R');
} else {
    $response = \Livewire\Livewire::mount('admin.posts.posts-manage');
    $html = $response->html();
    $_instance->logRenderedChild('4xbc10R', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
