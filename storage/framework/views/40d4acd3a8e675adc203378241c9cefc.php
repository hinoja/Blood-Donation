...
} elseif ($_instance->childHasBeenRendered('Xk3jZIo')) {
    $componentId = $_instance->getRenderedChildComponentId('Xk3jZIo');
    $componentTag = $_instance->getRenderedChildComponentTagName('Xk3jZIo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Xk3jZIo');
} else {
    $response = \Livewire\Livewire::mount('admin.posts.posts-manage');
    $html = $response->html();
    $_instance->logRenderedChild('Xk3jZIo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
