...
} elseif ($_instance->childHasBeenRendered('ynsEJWs')) {
    $componentId = $_instance->getRenderedChildComponentId('ynsEJWs');
    $componentTag = $_instance->getRenderedChildComponentTagName('ynsEJWs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ynsEJWs');
} else {
    $response = \Livewire\Livewire::mount('admin.posts.posts-manage');
    $html = $response->html();
    $_instance->logRenderedChild('ynsEJWs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
