...
} elseif ($_instance->childHasBeenRendered('2g1F5VH')) {
    $componentId = $_instance->getRenderedChildComponentId('2g1F5VH');
    $componentTag = $_instance->getRenderedChildComponentTagName('2g1F5VH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2g1F5VH');
} else {
    $response = \Livewire\Livewire::mount('admin.contacts.contact-manage');
    $html = $response->html();
    $_instance->logRenderedChild('2g1F5VH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Benutzer\Blood\resources\views/admin/contacts/index.blade.php ENDPATH**/ ?>