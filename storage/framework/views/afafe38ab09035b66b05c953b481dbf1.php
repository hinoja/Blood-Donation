                        ...
                        <div class="overview-area__single-content">
                            <div class="poster">
                                <a href="service-details.html">
                                    <img src="<?php echo e(asset('assets/front/images/overview/donor.png')); ?>" alt="Blood Donor">
                                </a>
                            </div>
                            <div class="icon-box-wrapper">
                                <div class="icon-box">
                                    <img src="<?php echo e(asset('assets/front/images/overview/first-aid.png')); ?>"
                                        alt="First Aid">
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 row-item align-center">
                    <div class="overview-area__single img-effect wow fadeInUp">
                        <div class="overview-area__single-content">
                            <div class="poster">
                                <a href="service-details.html">
                                    <img src="<?php echo e(asset('assets/front/images/overview/blood.png')); ?>" alt="Give Blood">
                                </a>
                            </div>
                            <div class="icon-box-wrapper">
                                <div class="icon-box">
                                    <img src="<?php echo e(asset('assets/front/images/overview/tube.png')); ?>" alt="Tube">
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 row-item align-center">
                    <div class="overview-area__single img-effect wow fadeInUp" data-wow-delay="0.2s">
                        <div class="overview-area__single-content">
                            <div class="poster">
                                <a href="service-details.html">
                                    <img src="<?php echo e(asset('assets/front/images/overview/donations.png')); ?>"
                                        alt="Blood Donation">
                                </a>
                            </div>
                            <div class="icon-box-wrapper">
                                <div class="icon-box">
                                    <img src="<?php echo e(asset('assets/front/images/overview/heart.png')); ?>" alt="Heart">
                                </div>
                            </div>
...
<?php /**PATH E:\Laravel Projet\Blood_Donation\resources\views/includes/front/overview.blade.php ENDPATH**/ ?>